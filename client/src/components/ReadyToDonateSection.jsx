  ...
  return (
    ...
    >
      <Container>
        ...
        {/* ===== البطاقات الأربعة في Grid ===== */}
        <div className="donate-cards-grid">
          {/* بطاقة التبرع بالدم */}
          <Card
            className="donate-card blood-card reveal"
            data-animate="up"
          >
          ...
          {/* بطاقة التبرع العام */}
          <Card
            className="donate-card general-card reveal"
            data-animate="up"
          >
            <Card.Body className="p-4">
          ...
          <Card
            className="donate-card request-blood-card reveal"
            data-animate="up"
          >
            <Card.Body className="p-4">
          ...
          {/* بطاقة طلب تبرع عام */}
          <Card
            className="donate-card request-general-card reveal"
            data-animate="up"
          >
            <Card.Body className="p-4">
